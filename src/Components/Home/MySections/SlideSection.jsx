    ...
    <div className="z-0">
      <div className="" data-aos="zoom-in">
        ...
        >
          <SwiperSlide>
            <div>
              <div className="xl:min-h-[900px]  lg:min-h-[700px] md:min-h-[600px] min-h-[350px] bg-[url('https://i.ibb.co/JrHZ8QQ/world-1.png')] bg-no-repeat bg-cover bg-center flex justify-center items-center py-8 md:py-0">
                {/* Slider left Section */}
          ...
          <SwiperSlide>
            <div>
              <div className="xl:min-h-[900px]  lg:min-h-[700px] md:min-h-[600px] min-h-[350px] bg-[url('https://i.ibb.co/yyBjhnt/world-3.jpg')] bg-no-repeat bg-cover bg-center flex justify-center items-center py-8 md:py-0">
                {/* Slider left Section */}
          ...
          <SwiperSlide>
            <div>
              <div className="xl:min-h-[900px]  lg:min-h-[700px] md:min-h-[600px] min-h-[350px] bg-[url('https://i.ibb.co/XbMdL95/world2.jpg')] bg-no-repeat bg-cover bg-center flex justify-center items-center py-8 md:py-0">
                {/* Slider left Section */}
                <div className="w-[90%] mx-auto flex flex-col md:flex-row justify-between items-center md:gap-10 gap-4 p-2 ">
                  <div className="md:w-2/3 text-center md:text-left text-white md:ml-20">
