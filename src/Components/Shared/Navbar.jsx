...
const Navbar = () => {
  ...
  return (
    <div className="relative z-10">
     <div className="border-2 border-blue-400 bg-gradient-to-r from-blue-50 to-white ">
      <div className="navbar p-0 flex justify-between lg:px-20 md:px-10 px-3 max-w-[2000px] mx-auto">
