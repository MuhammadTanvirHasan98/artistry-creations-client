    ...
    <div className="text-center text-3xl mb-36">
      ...
      <div  data-aos="flip-right" className="my-10 w-[80%]  lg:w-[70%] mx-auto">
        <form onSubmit={handleFormSubmit}>
          ...
          >
            Submit Review<MdOutlineReviews className="md:text-2xl"/>
          </button>
        </form>
        ...
        <dialog id="my_modal" className="modal">
          <div className="modal-box w-11/12 max-w-5xl">
            <h3 className="font-bold text-3xl text-green-600">Your review text has been submitted!</h3>
            <p className="py-4 text-[25px] text-blue-600">Thanks for your precious review.</p>
